...
| NLS_DATE_FORMAT, NLS_TIMESTAMP_FORMAT | Часто устанавливается в приложениях Python для принудительного использования единого формата даты независимо от локали. Эти переменные игнорируются, если переменная окружения NLS_LANGне установлена.  | Толстый |
